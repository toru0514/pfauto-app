...
- `minne_category_parent_id`, `minne_category_id`, `minne_image_urls`, `minne_shipping_method`, `minne_shipping_area`, `minne_shipping_fee`, `minne_shipping_additional_fee`, `minne_required_options`: minne 専用列。大カテゴリ/小カテゴリ ID を組み合わせてフォームに反映し、配送設定や画像URLもこれらの列から優先的に参照する。空欄の場合は共通列（`category_common`, `image_urls`, `shipping_*`）をフォールバックとし、未解決項目は警告ログを出す。
- `base_title`, `base_description`, `base_price`, `base_inventory`, `base_image_urls`: BASE 専用列。未入力の場合は共通列 (`title`, `description`, `price`, `inventory`, `image_urls`) をフォールバックとして使用し、`出品先` に `base` が含まれる行のみ Playwright の BASE フローに引き渡される。
- `iichi_category_parent_label`, `iichi_category_child_label`, `iichi_material_label`, `iichi_shipping_method_label`, `iichi_image_urls`: iichi 専用列。Element Plus ベースのセレクトに表示されるラベル文字列を記載し、マッチする候補をクリック選択する。空欄の場合は `category_common`, `material`, `shipping_method` 等の共通列から補完を試みるが、確実な値を設定することを推奨。
- PF固有列は `<pf>_<domain>_<name>` 命名を基本とし、追加PFにも拡張しやすいよう運用する。

#### スプレッドシートテンプレート（例）
```text
product_id | sku | title | description | price | inventory | material | size_notes | weight_grams | tags | creema_category_level1_label | creema_category_level2_label | creema_category_level3_label | creema_category_id | creema_category2_id | creema_category3_id | category_common | image_urls | base_title | base_description | base_price | base_inventory | base_image_urls | minne_category_parent_id | minne_image_urls | minne_shipping_method | minne_shipping_area | minne_shipping_fee | minne_shipping_additional_fee | creema_color_ids | variant_options | production_lead_time_days | shipping_fee | shipping_method | shipping_origin_pref | 出品先 | ステータス | minne_category_id | notes_internal | creema_last_job_started_at | creema_last_duration_seconds | creema_attempt | minne_status | minne_last_synced_at | minne_last_error | minne_last_job_started_at | minne_last_duration_seconds | minne_attempt | iichi_category_parent_label | iichi_category_child_label | iichi_material_label | iichi_shipping_method_label | iichi_image_urls
hand-001 | HM-001 | 春色ブーケピアス | 淡いカラーの花をモチーフにした揺れるタイプのピアス。金具はステンレス製で肌にやさしい仕上げです。 | 3500 | 5 | 真鍮,ガラス | 全長約3cm | 12 | ピアス,春,花 | アクセサリー・ジュエリー | ピアス | ピアス（フープ） | 2 | 216 | 72 | アクセサリー/ピアス | https://images.microcms-assets.io/assets/f76a4988862a4d59968538e5355a57d3/c26b6b3f7a56472e9f0e48df08ebcb67/2025-08-10_14-46-58_730.jpeg | 春色ブーケピアス | 淡いカラーの花をモチーフにした揺れるタイプのピアス。BASE用説明です。 | 3500 | 5 | https://images.microcms-assets.io/assets/f76a4988862a4d59968538e5355a57d3/c26b6b3f7a56472e9f0e48df08ebcb67/2025-08-10_14-46-58_730.jpeg | 1 | https://images.microcms-assets.io/assets/f76a4988862a4d59968538e5355a57d3/c26b6b3f7a56472e9f0e48df08ebcb67/2025-08-10_14-46-58_730.jpeg | 宅急便コンパクト | 全国一律 | 250 | 0 | 10 | {"option":"カラー","values":["ピンク","ブルー"]} | 7 | 250 | 宅急便コンパクト | 東京都 | creema,minne,base | 下書き準備済み | 101 | 母の日特集向けアイテム。 | | | | ready | | | | | アクセサリー | ピアス | 真鍮 | ネコポス | https://images.microcms-assets.io/assets/f76a4988862a4d59968538e5355a57d3/c26b6b3f7a56472e9f0e48df08ebcb67/2025-08-10_14-46-58_730.jpeg
hand-002 | HM-002 | 木製カトラリーセット | 国産材を使ったスプーンとフォークの2本セット。オイル仕上げでお手入れも簡単です。 | 2800 | 10 | サクラ材 | スプーン/フォーク 各16cm | 80 | カトラリー,木製,ギフト | 食器・キッチン | 箸・カトラリー |  | 14 | 241 |  | キッチン/カトラリー | https://images.microcms-assets.io/assets/f76a4988862a4d59968538e5355a57d3/c26b6b3f7a56472e9f0e48df08ebcb67/2025-08-10_14-46-58_730.jpeg |  |  |  |  |  | 269 | https://images.microcms-assets.io/assets/f76a4988862a4d59968538e5355a57d3/c26b6b3f7a56472e9f0e48df08ebcb67/2025-08-10_14-46-58_730.jpeg | 宅急便コンパクト | 関東 | 520 | 0 | 4 |  | 5 | 520 | 宅急便コンパクト | 埼玉県 | minne | 下書き準備済み | 241 | minne限定。 | | | | ready | | | | | 食器・キッチン | カトラリー | 木 | 宅配便 | https://images.microcms-assets.io/assets/f76a4988862a4d59968538e5355a57d3/c26b6b3f7a56472e9f0e48df08ebcb67/2025-08-10_14-46-58_730.jpeg
hand-003 | HM-003 | レザーコードブレスレット | しなやかな本革コードを編み込んだブレスレット。マグネット金具で着脱も簡単です。 | 4200 | 8 | 本革,真鍮 | 内周約17cm | 25 | ブレスレット,ユニセックス,ギフト | アクセサリー・ジュエリー | ブレスレット・バングル |  | 2 | 65 |  | アクセサリー/ブレスレット | https://images.microcms-assets.io/assets/f76a4988862a4d59968538e5355a57d3/c26b6b3f7a56472e9f0e48df08ebcb67/2025-08-10_14-46-58_730.jpeg |  |  |  |  |  | 2 | https://images.microcms-assets.io/assets/f76a4988862a4d59968538e5355a57d3/c26b6b3f7a56472e9f0e48df08ebcb67/2025-08-10_14-46-58_730.jpeg | 宅急便コンパクト | 神奈川 | 370 | 0 | 14 | {"option":"サイズ","values":["S","M","L"]} | 10 | 370 | 宅急便コンパクト | 神奈川県 | creema | 下書き準備済み | 65 | 父の日ギフト候補。 | | | | ready | | | | | アクセサリー | ブレスレット | レザー | 宅配便 | https://images.microcms-assets.io/assets/f76a4988862a4d59968538e5355a57d3/c26b6b3f7a56472e9f0e48df08ebcb67/2025-08-10_14-46-58_730.jpeg
```
